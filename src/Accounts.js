...
import { BsFilter,BsFillMicFill } from "react-icons/bs"
    ...
    return (
      <div className='chartsBgImage'>
        <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", backgroundColor: COLORS.CINDER,paddingTop:"5px",height:"50px" }}>
          ...
          <div >
            <AiOutlineShop size={25} color={COLORS.BRIGHT_GREY}/>
    ...
    <div className='homeContainer'>
      <div className="accountPortion">
        <div style={{ backgroundColor:COLORS.CINDER, display: "flex", flexDirection: "row", justifyContent: "space-between", padding: "5px" }}>
          <div>
            <img src='https://media.licdn.com/dms/image/C5603AQGhcO7OR5bSLg/profile-displayphoto-shrink_800_800/0/1652188960503?e=2147483647&v=beta&t=XM7JxHvBH0SGXAlCudqAWQ3_lKhWDffFS6c6ZBsMLAQ' height={40} width={40} style={{ borderRadius: "40px" }} alt={"logo"} />
          </div>
          <div style={{ marginTop: "10px" }}>
            <MdGroups2 size={25} color={COLORS.BRIGHT_GREY} />
            <TbCircleDashed size={25} color={COLORS.BRIGHT_GREY} style={{ marginLeft: "20px" }} />
            <MdOutlineMessage size={25} color={COLORS.BRIGHT_GREY} style={{ marginLeft: "20px" }} />
            <CiMenuKebab size={25} color={COLORS.BRIGHT_GREY} style={{ marginLeft: "20px" }} />
          </div>
        </div>
        <div className='homeContainer' style={{ marginTop: "10px", padding: "5px", height: "35px" }}>
          <div style={{
            ...
            <BiSearch size={20} color={COLORS.BRIGHT_GREY} />
          ...
          <div>
            <BsFilter size={25} color={COLORS.BRIGHT_GREY} />
          </div>
        </div>
